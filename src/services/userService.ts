...
export const DEFAULT_USERS = [
  ...
  },
  {
    ...
    schoolId: 'balarmalar parramatta branch',
    languagePreference: 'ta',
    associatedStudents: ['demo_student_placeholder', 'demo_student_2_placeholder'],
  ...
  {
    uid: 'demo_student_2_placeholder',
    email: 'demostudent2@balarmalar.nsw.edu.au',
    fullName: 'Demo Student 2 (Parramatta)',
    role: 'student',
    phone: '',
    schoolId: 'balarmalar parramatta branch',
    languagePreference: 'ta',
    fullNameTamil: 'டெமோ மாணவர் 2',
    gender: 'Female',
    dateOfBirth: '2018-03-12',
    mainstreamSchoolName: 'Harris Park Public School',
    mainstreamSchoolClass: 'Year 3',
    className: 'Standard 1 - Demo',
    prevBmSchoolClass: 'Kindergarten',
    studentCreated: '2026-07-28 09:00:00',
    okToIssueBooks: 'YES',
  ...
  {
    uid: 'dummy_student_1',
    email: 'dummystudent1@example.com',
    fullName: 'Arjun Kumar',
    role: 'student',
    phone: '',
    schoolId: 'balarmalar parramatta branch',
    languagePreference: 'en',
    fullNameTamil: 'அர்ஜுன் குமார்',
    gender: 'Male',
    dateOfBirth: '2016-11-05',
    mainstreamSchoolName: 'Parramatta West Public School',
    mainstreamSchoolClass: 'Year 5',
    className: 'Standard 1 - Demo',
    prevBmSchoolClass: 'Year 1',
    studentCreated: '2026-07-28 09:00:00',
  ...
  },
  {
    ...
    fullName: 'Kavya Rajesh',
    role: 'student',
    phone: '',
    schoolId: 'balarmalar parramatta branch',
    languagePreference: 'ta',
    fullNameTamil: 'காவ்யா ராஜேஷ்',
    gender: 'Female',
